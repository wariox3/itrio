...
from humano.serializers.novedad_tipo import HumNovedadTipoSerializador, HumNovedadTipoSeleccionarSerializador
...
class HumNovedadTipoViewSet(viewsets.ModelViewSet):
    ...
    def seleccionar_action(self, request):
        ...
        try:
            ...
            pass    
        serializer = HumNovedadTipoSeleccionarSerializador(queryset, many=True)        
