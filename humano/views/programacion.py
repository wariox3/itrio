...
class HumProgramacionViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        ...
        if not serializador_parametro or serializador_parametro not in self.serializadores:
            return HumProgramacionSerializador
    ...
    def list(self, request, *args, **kwargs):
        if request.query_params.get('excel'):
            ...
            nombre_hoja = "programaciones"
            nombre_archivo = "programaciones.xlsx"
                        ...
                        if nomina.contacto:
                            if nomina.contacto.correo:
                                if Utilidades.correo_valido(nomina.contacto.correo):
                                    ...
                                    correo = Zinc()  
                                    correo.correo(nomina.contacto.correo, 'Notificacion nomina', contenido_html, 'reddoc', archivos)                 
