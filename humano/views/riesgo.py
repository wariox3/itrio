...
from humano.serializers.riesgo import HumRiesgoSerializador, HumRiesgoSeleccionarSerializador
...
class HumRiesgoViewSet(viewsets.ModelViewSet):
    ...
    def seleccionar_action(self, request):
        ...
        try:
            ...
            pass    
        serializer = HumRiesgoSeleccionarSerializador(queryset, many=True)        
