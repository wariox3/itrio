...
class HumAporteContrato(models.Model):        
    ...
    pension_empleado = models.DecimalField(max_digits=20, decimal_places=6, default=0)
    salud_empleado = models.DecimalField(max_digits=20, decimal_places=6, default=0)
    pension_empresa = models.DecimalField(max_digits=20, decimal_places=6, default=0)
    salud_empresa = models.DecimalField(max_digits=20, decimal_places=6, default=0)    
