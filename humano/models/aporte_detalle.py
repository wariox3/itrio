...
class HumAporteDetalle(models.Model):         
    ...
    aporte_voluntario_pension_afiliado = models.DecimalField(max_digits=20, decimal_places=6, default=0)
    aporte_voluntario_pension_aportante = models.DecimalField(max_digits=20, decimal_places=6, default=0)
    total_cotizacion_pension = models.DecimalField(max_digits=20, decimal_places=6, default=0)
    aporte_solidaridad_solidaridad = models.DecimalField(max_digits=20, decimal_places=6, default=0)
    aporte_solidaridad_subsistencia = models.DecimalField(max_digits=20, decimal_places=6, default=0)
