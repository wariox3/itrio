...
class HumAporteDetalleSerializador(serializers.HyperlinkedModelSerializer):    
    ...
    def to_representation(self, instance):         
        ...
        return {
            ...
            'aporte_solidaridad_solidaridad': instance.aporte_solidaridad_solidaridad,
            'aporte_solidaridad_subsistencia': instance.aporte_solidaridad_subsistencia,
            'aporte_voluntario_pension_afiliado': instance.aporte_voluntario_pension_afiliado,
            'aporte_voluntario_pension_aportante': instance.aporte_voluntario_pension_aportante,
...
class HumAporteDetalleExcelSerializador(serializers.HyperlinkedModelSerializer):
    ...
    def to_representation(self, instance):         
        ...
        return {
            ...
            'F_SOL': instance.aporte_solidaridad_solidaridad,
            'F_SUB': instance.aporte_solidaridad_subsistencia,
            'VOL_AFI': instance.aporte_voluntario_pension_afiliado,
            'VOL_APO': instance.aporte_voluntario_pension_aportante,
