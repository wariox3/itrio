...
from inquilino.serializers import UserSerializer, UserListSerializer
...
class UsuarioViewSet(viewsets.GenericViewSet):
    ...
    def get_queryset(self):
        if self.queryset is None:
            self.queryset = self.serializer_class.Meta.model.objects.all().values('id', 'username', 'email')
