...
from .views.general import ListaAdministradorView, ListaAutocompletarView, ListaBuscarView
...
urlpatterns = [    
    ...
    path('funcionalidad/lista-buscar/', ListaBuscarView.as_view(), name='general'),
