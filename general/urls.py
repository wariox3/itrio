...
from .views.general import ListaAdministradorView, ListaAutocompletarView, ListaMovimientoView
...
urlpatterns = [    
    ...
    path('funcionalidad/lista-movimiento/', ListaMovimientoView.as_view(), name='general'),
