...
class DocumentoDetalleFilter(django_filters.FilterSet):
    ...
    documento__contacto_id = django_filters.CharFilter(field_name='documento__contacto_id', lookup_expr='exact')
    documento__contrato_id = django_filters.CharFilter(field_name='documento__contrato_id', lookup_expr='exact')
    documento__fecha = django_filters.DateFilter(field_name='documento__fecha')
    documento__estado_aprobado = django_filters.BooleanFilter(field_name='documento__estado_aprobado', lookup_expr='exact')    
    ...
    documento__documento_tipo_id = django_filters.NumberFilter(field_name='documento__documento_tipo_id')
    documento__documento_tipo__documento_clase_id = django_filters.NumberFilter(field_name='documento__documento_tipo__documento_clase_id')
    ...
    class Meta:
        ...
        fields = {
                    ...
                    'documento__documento_tipo__documento_clase_id': ['exact'],                                     
                }