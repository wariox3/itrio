...
class GenDocumentoDetalle(models.Model):    
    ...
    documento_afectado = models.ForeignKey(GenDocumento, null=True, on_delete=models.PROTECT, related_name='documentos_detalles_documento_detalle_afectado_rel')
    documento_detalle_afectado = models.ForeignKey('self', null=True, on_delete=models.PROTECT, related_name='documentos_detalles_documento_afectado_rel')
    ...
    activo = models.ForeignKey(ConActivo, null=True, on_delete=models.PROTECT, related_name='documentos_detalles_activo_rel')
