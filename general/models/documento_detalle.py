...
class DocumentoDetalle(models.Model):    
    ...
    precio = models.DecimalField(max_digits=15, decimal_places=3, default=0)
    pago = models.DecimalField(max_digits=15, decimal_places=3, default=0)
    subtotal = models.DecimalField(max_digits=15, decimal_places=3, default=0)
    descuento = models.DecimalField(max_digits=15, decimal_places=3, default=0)
    total_bruto = models.DecimalField(max_digits=15, decimal_places=3, default=0)
    base_impuesto = models.DecimalField(max_digits=15, decimal_places=3, default=0)
    impuesto = models.DecimalField(max_digits=15, decimal_places=3, default=0)
    total = models.DecimalField(max_digits=15, decimal_places=3, default=0)
    porcentaje_descuento = models.DecimalField(max_digits=15, decimal_places=3, default=0)
