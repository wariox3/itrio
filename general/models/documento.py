...
class Documento(models.Model):    
    ...
    base_impuesto = models.DecimalField(max_digits=12, decimal_places=6, default=0)
    descuento = models.DecimalField(max_digits=12, decimal_places=6, default=0)
    impuesto = models.DecimalField(max_digits=12, decimal_places=6, default=0)
    cobrar = models.DecimalField(max_digits=12, decimal_places=6, default=0)
    cobrar_afectado = models.DecimalField(max_digits=12, decimal_places=6, default=0)
    cobrar_pendiente = models.DecimalField(max_digits=12, decimal_places=6, default=0)
