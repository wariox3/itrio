...
class Documento(models.Model):    
    ...
    cobrar = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    cobrar_afectado = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    cobrar_pendiente = models.DecimalField(max_digits=15, decimal_places=2, default=0)
