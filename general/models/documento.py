...
class Documento(models.Model):    
    ...
    total_bruto = models.DecimalField(max_digits=16, decimal_places=2, default=0)
    base_impuesto = models.DecimalField(max_digits=16, decimal_places=2, default=0)
    ...
    afectado = models.DecimalField(max_digits=16, decimal_places=2, default=0)
    pendiente = models.DecimalField(max_digits=16, decimal_places=2, default=0)
