...
class Documento(models.Model):    
    ...
    subtotal = models.DecimalField(max_digits=15, decimal_places=6, default=0)
    total = models.DecimalField(max_digits=15, decimal_places=6, default=0)
    total_bruto = models.DecimalField(max_digits=15, decimal_places=6, default=0)
    base_impuesto = models.DecimalField(max_digits=15, decimal_places=6, default=0)
    descuento = models.DecimalField(max_digits=15, decimal_places=6, default=0)
    impuesto = models.DecimalField(max_digits=15, decimal_places=6, default=0)    
    afectado = models.DecimalField(max_digits=15, decimal_places=6, default=0)
    pendiente = models.DecimalField(max_digits=15, decimal_places=6, default=0)
