...
class DocumentoImpuesto(models.Model):   
    base = models.DecimalField(max_digits=16, decimal_places=2, default=0)     
    porcentaje = models.DecimalField(max_digits=16, decimal_places=2, default=0)
    porcentaje_base = models.DecimalField(max_digits=16, decimal_places=2, default=100)
