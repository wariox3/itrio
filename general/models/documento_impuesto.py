...
class DocumentoImpuesto(models.Model):   
    base = models.DecimalField(max_digits=10, decimal_places=6, default=0)     
    porcentaje = models.DecimalField(max_digits=10, decimal_places=6, default=0)
    porcentaje_base = models.DecimalField(max_digits=10, decimal_places=6, default=100)
    total = models.DecimalField(max_digits=10, decimal_places=6, default=0)
