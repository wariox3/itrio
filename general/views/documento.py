...
from general.serializers.documento import GenDocumentoDetalleCierreSerializador, GenDocumentoSerializador, GenDocumentoListaSerializador, GenDocumentoListaNominaSerializador, GenDocumentoDetalleNominaSerializador, GenDocumentoListaVentaSerializador, GenDocumentoInformeSerializador, GenDocumentoInformeCuentaCobrarSerializador, GenDocumentoRetrieveSerializador, GenDocumentoSeleccionarSerializador, GenDocumentoAdicionarSerializador, GenDocumentoReferenciaSerializador, GenDocumentoEventoCompraSerializador, GenDocumentoNominaSerializador, GenDocumentoNominaExcelSerializador, GenDocumentoNominaElectronicaExcelSerializador
...
class DocumentoViewSet(viewsets.ModelViewSet):
    ...
    serializadores = {
        ...
        'detalle_cierre': GenDocumentoDetalleCierreSerializador,
        ...
        'informe_nomina': GenDocumentoNominaExcelSerializador,
        'informe_nomina_electronica': GenDocumentoNominaElectronicaExcelSerializador,
        ...
        if request.query_params.get('excel'):
            ...
            if request.query_params.get('excel_masivo'):
                ...
                if serializador_parametro == 'informe_nomina':
                    ...
                    nombre_archivo = "nóminas.xlsx"         
                    nombre_hoja = 'nóminas'           
                if serializador_parametro == 'informe_nomina_electronica':
                    titulo = 'Nominas electrónicas' 
                    nombre_archivo = "nóminas_electrónicas.xlsx"         
                    nombre_hoja = 'nóminas_electrónicas'       
            ...
            try:
                with transaction.atomic():
                    ...
                    if documento.estado_aprobado == True and documento.estado_anulado == False and documento.estado_contabilizado == False and documento.estado_electronico_enviado == False:                                  
                        if documento.documento_tipo.documento_clase_id in (100,101,102,104,105,200,300,301,303,400,500,501,601,603):                    
        ...
        if anio and mes:
            with transaction.atomic():                    
                ...
                nominas_mes = GenDocumento.objects.filter(
                        Q(documento_tipo_id=14) | Q(documento_tipo_id=28) | Q(documento_tipo_id=20) | Q(documento_tipo_id=21) | Q(documento_tipo_id=33),
